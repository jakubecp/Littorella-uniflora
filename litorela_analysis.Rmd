...
ggsave("outputs/substrate.tiff",dpi=300, scale=1.5)
...
#save the output graph
ggsave("outputs/locality.tiff",dpi=300, scale=1.5)
...
#save the output graph
ggsave("outputs/climabox.tiff",dpi=300, scale=1.5)
...
#save the output graph
ggsave("outputs/glasshouse.tiff",dpi=300, scale=1.5)
```
